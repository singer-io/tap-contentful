...
from tap_contentful.streams.abstracts import IncrementalStream
...
class TestSync(unittest.TestCase):
    ...
    @patch("tap_contentful.streams.abstracts.get_bookmark", return_value=100)
    ...
    @patch("tap_contentful.streams.abstracts.get_bookmark", return_value=300)
